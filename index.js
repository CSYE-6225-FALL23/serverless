...
exports.handler = async (event, context) => {
    try {
        ...
        const { submissionUrl, email, userId, submissionId, assignmentId } = snsMessage;
...
const downloadSubmissionZip = async (submissionUrl) => {
    try {
        ...
        console.info('Downloaded zip file from URL', JSON.stringify({
...
const uploadToGCS = async (submissionFile, assignmentId, userId) => {
    ...
    try {
        ...
        const gcsBucketName = process.env.GCSBucketName;
